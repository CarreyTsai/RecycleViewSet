...
public abstract class ItemViewDelegate<T, VH extends ViewHolder> {
    ...
    MultiTypeAdapter getAdapter() {
        if (adapter == null) {
            throw new IllegalStateException("ItemViewDelegate " + this + " not attached into MultiTypeAdapter. " +
